...
=========================================================================*/
#ifndef __DumpArray_h_
#define __DumpArray_h_

#include "CommandAdapter.h"

class DumpArray : public CommandAdapter
{
public:
